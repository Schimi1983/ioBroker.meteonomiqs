...
exports.NOW_PREFIX = exports.LANGUAGES = void 0;
exports.label = label;
exports.prefixed = prefixed;
exports.dayLabel = dayLabel;
exports.dayPrefix = dayPrefix;
exports.daySegmentPrefix = daySegmentPrefix;
exports.dayHourPrefix = dayHourPrefix;
 ...
 */
exports.LANGUAGES = ['en', 'de', 'ru', 'pt', 'nl', 'fr', 'it', 'es', 'pl', 'uk', 'zh-cn'];
/**
 ...
 */
function forEachLanguage(build) {
    return {
        en: build('en'),
        de: build('de'),
        ru: build('ru'),
 ...
 */
function tr(en, de, ru, pt, nl, fr, it, es, pl, uk, zh) {
...
const LABELS = {
    ...
    'Average temperature': tr('Average temperature', 'Durchschnittstemperatur', 'Средняя температура', 'Temperatura média', 'Gemiddelde temperatuur', 'Température moyenne', 'Temperatura media', 'Temperatura media', 'Średnia temperatura', 'Середня температура', '平均气温'),
    ...
    'Feels like max.': tr('Feels like max.', 'Gefühlt max.', 'Ощущается макс.', 'Sensação térmica máx.', 'Gevoelstemperatuur max.', 'Ressenti max.', 'Percepita max.', 'Sensación térmica máx.', 'Odczuwalna maks.', 'Відчувається макс.', '体感温度最高'),
    ...
    'Max. temperature today': tr('Max. temperature today', 'Max. Temperatur heute', 'Макс. температура сегодня', 'Temperatura máx. hoje', 'Max. temperatuur vandaag', "Température max. aujourd'hui", 'Temperatura max. oggi', 'Temperatura máx. hoy', 'Temperatura maks. dziś', 'Макс. температура сьогодні', '今日最高气温'),
    'Max. wind speed': tr('Max. wind speed', 'Max. Windgeschwindigkeit', 'Макс. скорость ветра', 'Velocidade máx. do vento', 'Max. windsnelheid', 'Vitesse max. du vent', 'Velocità max. del vento', 'Velocidad máx. del viento', 'Maks. prędkość wiatru', 'Макс. швидкість вітру', '最大风速'),
    ...
    'Min. temperature today': tr('Min. temperature today', 'Min. Temperatur heute', 'Мин. температура сегодня', 'Temperatura mín. hoje', 'Min. temperatuur vandaag', "Température min. aujourd'hui", 'Temperatura min. oggi', 'Temperatura mín. hoy', 'Temperatura min. dziś', 'Мін. температура сьогодні', '今日最低气温'),
    Night: tr('Night', 'Nacht', 'Ночь', 'Noite', 'Nacht', 'Nuit', 'Notte', 'Noche', 'Noc', 'Ніч', '夜间'),
    'Precipitation amount': tr('Precipitation amount', 'Niederschlagsmenge', 'Количество осадков', 'Quantidade de precipitação', 'Neerslaghoeveelheid', 'Quantité de précipitations', 'Quantità di precipitazioni', 'Cantidad de precipitación', 'Suma opadów', 'Кількість опадів', '降水量'),
    'Precipitation class (0-3)': tr('Precipitation class (0-3)', 'Niederschlagsklasse (0-3)', 'Класс осадков (0-3)', 'Classe de precipitação (0-3)', 'Neerslagklasse (0-3)', 'Classe de précipitations (0-3)', 'Classe di precipitazioni (0-3)', 'Clase de precipitación (0-3)', 'Klasa opadów (0-3)', 'Клас опадів (0-3)', '降水等级 (0-3)'),
    'Precipitation probability': tr('Precipitation probability', 'Regenrisiko', 'Вероятность осадков', 'Probabilidade de precipitação', 'Neerslagkans', 'Probabilité de précipitations', 'Probabilità di precipitazioni', 'Probabilidad de precipitación', 'Prawdopodobieństwo opadów', 'Ймовірність опадів', '降水概率'),
    ...
    'Relative humidity': tr('Relative humidity', 'Relative Feuchte', 'Относительная влажность', 'Humidade relativa', 'Relatieve vochtigheid', 'Humidité relative', 'Umidità relativa', 'Humedad relativa', 'Wilgotność względna', 'Відносна вологість', '相对湿度'),
    ...
    'Snow (water equivalent)': tr('Snow (water equivalent)', 'Schnee (Wasseräquivalent)', 'Снег (водный эквивалент)', 'Neve (equivalente em água)', 'Sneeuw (waterequivalent)', 'Neige (équivalent en eau)', 'Neve (equivalente in acqua)', 'Nieve (equivalente en agua)', 'Śnieg (ekwiwalent wodny)', 'Сніг (водний еквівалент)', '降雪（水当量）'),
    ...
    'Snow line max.': tr('Snow line max.', 'Schneefallgrenze max.', 'Снеговая линия макс.', 'Cota de neve máx.', 'Sneeuwgrens max.', 'Limite pluie-neige max.', 'Quota neve max.', 'Cota de nieve máx.', 'Granica śniegu maks.', 'Снігова лінія макс.', '雪线最高'),
    'Snow line min.': tr('Snow line min.', 'Schneefallgrenze min.', 'Снеговая линия мин.', 'Cota de neve mín.', 'Sneeuwgrens min.', 'Limite pluie-neige min.', 'Quota neve min.', 'Cota de nieve mín.', 'Granica śniegu min.', 'Снігова лінія мін.', '雪线最低'),
    ...
    'Timestamp (UTC)': tr('Timestamp (UTC)', 'Zeitstempel (UTC)', 'Метка времени (UTC)', 'Data/hora (UTC)', 'Tijdstempel (UTC)', 'Horodatage (UTC)', 'Marca temporale (UTC)', 'Marca de tiempo (UTC)', 'Znacznik czasu (UTC)', 'Мітка часу (UTC)', '时间戳 (UTC)'),
    ...
    'Warning severity': tr('Warning severity', 'Warnung Schweregrad', 'Уровень предупреждения', 'Gravidade do aviso', 'Ernst van de waarschuwing', "Gravité de l'alerte", "Gravità dell'allerta", 'Gravedad del aviso', 'Poziom ostrzeżenia', 'Рівень попередження', '警报级别'),
    'Warning severity (0-4)': tr('Warning severity (0-4)', 'Warnung Schweregrad (0-4)', 'Уровень предупреждения (0-4)', 'Gravidade do aviso (0-4)', 'Ernst van de waarschuwing (0-4)', "Gravité de l'alerte (0-4)", "Gravità dell'allerta (0-4)", 'Gravedad del aviso (0-4)', 'Poziom ostrzeżenia (0-4)', 'Рівень попередження (0-4)', '警报级别 (0-4)'),
    ...
    'Wind direction (degrees)': tr('Wind direction (degrees)', 'Windrichtung (Grad)', 'Направление ветра (градусы)', 'Direção do vento (graus)', 'Windrichting (graden)', 'Direction du vent (degrés)', 'Direzione del vento (gradi)', 'Dirección del viento (grados)', 'Kierunek wiatru (stopnie)', 'Напрямок вітру (градуси)', '风向（度）'),
    'Wind direction (short)': tr('Wind direction (short)', 'Windrichtung (kurz)', 'Направление ветра (кратко)', 'Direção do vento (abrev.)', 'Windrichting (kort)', 'Direction du vent (abrégé)', 'Direzione del vento (breve)', 'Dirección del viento (abrev.)', 'Kierunek wiatru (skrót)', 'Напрямок вітру (скорочено)', '风向（缩写）'),
    ...
    'Wind speed (avg)': tr('Wind speed (avg)', 'Windgeschwindigkeit (Ø)', 'Скорость ветра (сред.)', 'Velocidade do vento (méd.)', 'Windsnelheid (gem.)', 'Vitesse du vent (moy.)', 'Velocità del vento (media)', 'Velocidad del viento (prom.)', 'Prędkość wiatru (śr.)', 'Швидкість вітру (сер.)', '风速（平均）'),
    // ------------------------------------------------------------ sun and moon
    ...
    'Moon zodiac': tr('Moon zodiac', 'Mond-Tierkreiszeichen', 'Знак зодиака Луны', 'Signo zodiacal da Lua', 'Dierenriemteken van de maan', 'Signe zodiacal de la Lune', 'Segno zodiacale lunare', 'Signo zodiacal lunar', 'Znak zodiaku Księżyca', 'Знак зодіаку Місяця', '月亮星座'),
    'Moon zodiac (1-12)': tr('Moon zodiac (1-12)', 'Mond-Tierkreiszeichen (1-12)', 'Знак зодиака Луны (1-12)', 'Signo zodiacal da Lua (1-12)', 'Dierenriemteken van de maan (1-12)', 'Signe zodiacal de la Lune (1-12)', 'Segno zodiacale lunare (1-12)', 'Signo zodiacal lunar (1-12)', 'Znak zodiaku Księżyca (1-12)', 'Знак зодіаку Місяця (1-12)', '月亮星座 (1-12)'),
    ...
    'Sunset (ISO)': tr('Sunset (ISO)', 'Sonnenuntergang (ISO)', 'Заход солнца (ISO)', 'Pôr do sol (ISO)', 'Zonsondergang (ISO)', 'Coucher du soleil (ISO)', 'Tramonto (ISO)', 'Puesta del sol (ISO)', 'Zachód słońca (ISO)', 'Захід сонця (ISO)', '日落 (ISO)'),
    // ------------------------------------------------------------- info states
    ...
    'Last update (timestamp)': tr('Last update (timestamp)', 'Letztes Update (Zeitstempel)', 'Последнее обновление (метка времени)', 'Última atualização (data/hora)', 'Laatste update (tijdstempel)', 'Dernière mise à jour (horodatage)', 'Ultimo aggiornamento (marca temporale)', 'Última actualización (marca de tiempo)', 'Ostatnia aktualizacja (znacznik czasu)', 'Останнє оновлення (мітка часу)', '最后更新（时间戳）'),
    'Requests this month': tr('Requests this month', 'Anfragen Monat', 'Запросов за месяц', 'Pedidos este mês', 'Aanvragen deze maand', 'Requêtes ce mois-ci', 'Richieste questo mese', 'Peticiones este mes', 'Zapytania w tym miesiącu', 'Запитів цього місяця', '本月请求数'),
    ...
    'Remaining requests': tr('Remaining requests', 'Verbleibende Anfragen', 'Осталось запросов', 'Pedidos restantes', 'Resterende aanvragen', 'Requêtes restantes', 'Richieste rimanenti', 'Peticiones restantes', 'Pozostałe zapytania', 'Залишилось запитів', '剩余请求数'),
    ...
    'Forecast issued (API)': tr('Forecast issued (API)', 'Vorhersage erstellt (API)', 'Прогноз создан (API)', 'Previsão emitida (API)', 'Verwachting opgesteld (API)', 'Prévision émise (API)', 'Previsione emessa (API)', 'Pronóstico emitido (API)', 'Prognoza wydana (API)', 'Прогноз створено (API)', '预报发布时间 (API)'),
    'Next API update': tr('Next API update', 'Nächstes API-Update', 'Следующее обновление API', 'Próxima atualização da API', 'Volgende API-update', "Prochaine mise à jour de l'API", 'Prossimo aggiornamento API', 'Próxima actualización de la API', 'Następna aktualizacja API', 'Наступне оновлення API', '下次 API 更新'),
    'Location in use': tr('Location in use', 'Verwendeter Standort', 'Используемое местоположение', 'Localização utilizada', 'Gebruikte locatie', 'Emplacement utilisé', 'Posizione utilizzata', 'Ubicación utilizada', 'Używana lokalizacja', 'Використане розташування', '使用的位置'),
    'Time zone of the location': tr('Time zone of the location', 'Zeitzone des Standorts', 'Часовой пояс местоположения', 'Fuso horário da localização', 'Tijdzone van de locatie', 'Fuseau horaire du lieu', 'Fuso orario della posizione', 'Zona horaria de la ubicación', 'Strefa czasowa lokalizacji', 'Часовий пояс розташування', '位置时区'),
    ...
    'Reset monthly counter': tr('Reset monthly counter', 'Monatszähler zurücksetzen', 'Сбросить месячный счётчик', 'Repor contador mensal', 'Maandteller resetten', 'Réinitialiser le compteur mensuel', 'Azzera contatore mensile', 'Restablecer contador mensual', 'Zresetuj licznik miesięczny', 'Скинути місячний лічильник', '重置月度计数器'),
    ...
    'Hourly values (JSON)': tr('Hourly values (JSON)', 'Stundenwerte (JSON)', 'Почасовые значения (JSON)', 'Valores horários (JSON)', 'Uurwaarden (JSON)', 'Valeurs horaires (JSON)', 'Valori orari (JSON)', 'Valores horarios (JSON)', 'Wartości godzinowe (JSON)', 'Погодинні значення (JSON)', '逐小时数值 (JSON)'),
 ...
 * @returns Translation map.
 */
function daySegmentPrefix(index, segment) {
 ...
 * @returns Translation map.
 */
function dayHourPrefix(index, hour) {
    const day = dayLabel(index);
