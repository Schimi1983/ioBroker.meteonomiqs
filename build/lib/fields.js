...
exports.DAY_FIELDS = [
    ...
    { id: 'prec_probability', name: 'Precipitation probability', nameDe: 'Regenrisiko', type: 'number', role: 'value.precipitation.probability', unit: '%', digits: 0, get: (d) => d.prec?.probability },
    ...
    { id: 'sun_hours', name: 'Sunshine hours', nameDe: 'Sonnenstunden', type: 'number', role: 'value.sun', unit: 'h', digits: 1, get: (d) => d.sunHours },
    ...
    { id: 'wind_speed_max', name: 'Max. wind speed', nameDe: 'Max. Windgeschwindigkeit', type: 'number', role: 'value.speed.wind.max', unit: 'km/h', digits: 1, get: (d) => d.wind?.max ?? d.wind?.avg },
...
exports.HOUR_FIELDS = [
    ...
    { id: 'prec_prob', name: 'Precipitation probability', nameDe: 'Regenwahrscheinlichkeit', type: 'number', role: 'value.precipitation.probability', unit: '%', digits: 0, get: (h) => h.prec?.probability },
