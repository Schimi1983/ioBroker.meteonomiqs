...
export const DAY_FIELDS: FieldDef[] = [
    ...
    { id: 'prec_probability', name: 'Precipitation probability', nameDe: 'Regenrisiko', type: 'number', role: 'value.precipitation.chance', unit: '%', digits: 0, get: (d: ApiSummaryItem) => d.prec?.probability },
    ...
    { id: 'sun_hours', name: 'Sunshine hours', nameDe: 'Sonnenstunden', type: 'number', role: 'value', unit: 'h', digits: 1, get: (d: ApiSummaryItem) => d.sunHours },
    ...
    { id: 'wind_direction_short', name: 'Wind direction (short)', nameDe: 'Windrichtung (kurz)', type: 'string', role: 'weather.direction.wind', get: (d: ApiSummaryItem) => d.wind?.text },
...
export const SPACE_FIELDS: FieldDef[] = [
    ...
    { id: 'sun_hours', name: 'Sunshine hours', nameDe: 'Sonnenstunden', type: 'number', role: 'value', unit: 'h', digits: 1, get: (s: ApiSpaceItem) => s.sunHours },
...
export const HOUR_FIELDS: FieldDef[] = [
    ...
    { id: 'sun_hours', name: 'Sunshine hours', nameDe: 'Sonnenstunden', type: 'number', role: 'value', unit: 'h', digits: 2, get: (h: ApiHourlyItem) => h.sunHours },
