 ...
 */
export function msUntilDaily(hour: number, minute: number, now: Date = new Date()): number {
 ...
 * @returns See return type.
 */
export function scheduleDaily(host: SchedulerHost, hour: number, minute: number, callback: () => void): TimerHandle {
    let handle: any = null;
    let cancelled = false;
 ...
 * @returns See return type.
 */
export function scheduleHourly(host: SchedulerHost, minute: number, callback: () => void): TimerHandle {
    let handle: any = null;
    let cancelled = false;
